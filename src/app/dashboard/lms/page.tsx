            ...
            <div key={course.id} className="card bg-base-100 shadow-sm border border-base-200 hover:shadow-md transition-all group">
              <div className="card-body">
                <div className="flex justify-between items-start">
                  <div className={`badge badge-soft font-bold ${getRatingColor(course.minRating)} badge-sm opacity-80`}>
                    Min: {getRatingLabel(course.minRating).split(' - ')[0]}
                  </div>
                  {course.isCompleted && (
                    <div className="badge badge-success badge-soft font-semibold badge-sm gap-1">
                ...
                <div className="card-actions justify-end mt-4 items-center">
                  ...
                  <Link href={`/dashboard/lms/${course.id}`} className="btn btn-primary btn-sm btn-soft">
